...
const main = () => {
                ...
                <div class="col-md-4 mb-4" style="margin: auto">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-danger col-md-12" onclick="deleteProduct('${_id}')">Eliminar</button>
                        </div>
                    </div>
                </div>
            `;
    ...
    socket.on("deleted product", (id) => {
        Toastify({
            ...
            style: {
                background:
                    "linear-gradient(to right, rgb(151, 31, 47), rgb(180, 60, 60), rgb(163, 23, 23))",
            },
        }).showToast();
    });
};
